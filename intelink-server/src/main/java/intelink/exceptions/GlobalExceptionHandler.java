...
import intelink.dto.exception.ExceptionResponse;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ShortUrlPasswordIncorrectException.class)
    public ResponseEntity<?> handleIncorrectShortUrlPasswordException(ShortUrlPasswordIncorrectException e) {
        log.error("Short URL password incorrect: {}", e.getMessage());
        HttpStatus status = HttpStatus.UNAUTHORIZED;
        ExceptionResponse response = ExceptionResponse.builder()
                .statusCode(status.value())
                .errorType(status.getReasonPhrase())
